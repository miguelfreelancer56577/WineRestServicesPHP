...
class Status_Employee_Catalog extends Restservices {
    ...
    {   
        ...
        $headerResponse->businessResponse = $this->status_employee_model->getAll();
    ...
    public function getById_post()
    {
        ...
        $response = $this->status_employee_model->getById($this->headerRequest->businessRequest);
        if($response){
    ...
    public function getByName_post()
    {
        ...
        $response = $this->status_employee_model->getByName($this->headerRequest->businessRequest);
        if($response){
            $headerResponse->businessResponse = $response;
        }else{
            $headerResponse->status = 404;
    ...
    public function insert_post()
    {
        ...
        try{
            $response = $this->status_employee_model->insert($this->headerRequest->businessRequest);
            if($response){
                $headerResponse->businessResponse = $response;
            }
    ...
    public function deleteById_post()
    {
        ...
        $response = $this->status_employee_model->deleteById($this->headerRequest->businessRequest);
        if($response){
            $headerResponse->businessResponse = $response;
        }else{
            $headerResponse->status = 403;
    ...
    public function update_post()
    {
        ...
        try{
            $response = $this->status_employee_model->update($this->headerRequest->businessRequest);
            if($response){
                $headerResponse->businessResponse = $response;
            }
        }catch(RestException $e){
